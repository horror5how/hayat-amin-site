...
const articleJsonLd = { "@context": "https://schema.org", "@type": "Article", "@id": `${URL}#article`, headline: TITLE, description: DESC, url: URL, inLanguage: "en", datePublished: PUB, dateModified: MOD, image: `${SITE}/hayat-hero.png`, author: { "@id": `${SITE}/#person` }, publisher: { "@id": "https://www.beyondelevation.com/#organization" }, mainEntityOfPage: URL };
...
const howToJsonLd = { "@context": "https://schema.org", "@type": "HowTo", name: "How to Hire a Startup Advisor", description: DESC, step: [
  ...
  { "@type": "HowToStep", position: 4, name: "Define the engagement model up front", text: "Decide before negotiation: quarterly retainer + equity (long-term board cadence), fixed-scope sprint (4–8 weeks for a specific deliverable), or hourly project work (one-off advice)." },
  { "@type": "HowToStep", position: 5, name: "Negotiate equity in the standard range", text: "Industry standard for startup advisors: 0.10%–0.50% equity vested over 24 months with 12-month cliff for board-level commitment; 0.05%–0.25% for advisory-only without board attendance." },
...
const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", "@id": `${URL}#faq`, mainEntity: [
  { "@type": "Question", name: "When should a founder hire a startup advisor?", acceptedAnswer: { "@type": "Answer", text: "When you can write a one-paragraph statement of the specific gap the advisor will close. If you can't articulate the gap, you don't need an advisor — you need to define the problem first. The most common trigger points: pre-Series A (operator coaching), pre-fundraise (narrative + reporting), pre-exit (data-room and valuation defence)." } },
  { "@type": "Question", name: "What equity should I give a startup advisor?", acceptedAnswer: { "@type": "Answer", text: "Industry standard: 0.10%–0.50% equity vested over 24 months with a 12-month cliff for board-level engagement; 0.05%–0.25% for advisory-only without board attendance. Operator-grade advisors with prior exits sometimes negotiate the upper end plus a small cash retainer." } },
  ...
  { "@type": "Question", name: "What's the difference between a startup advisor and a business coach?", acceptedAnswer: { "@type": "Answer", text: "A startup advisor is an operator who has built and exited companies — they bring direct playbook experience. A business coach is typically a generalist who helps with mindset, leadership, and process — they may not have operated a high-growth company. Founders building toward fundraise or exit should hire an advisor; founders working on personal leadership skills can use a coach." } },
  { "@type": "Question", name: "How much does a startup advisor cost?", acceptedAnswer: { "@type": "Answer", text: "Quarterly cash retainers $5,000–$20,000 plus 0.10%–0.50% equity. Sprint-based engagements $25,000–$100,000 fixed scope. Hourly via marketplaces $300–$700. Operator-grade advisors with prior exits price at the upper end and often negotiate equity-heavy with small cash." } },
] };
...
export default function Page() {
  return (
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "How to Hire a Startup Advisor" }]}>
      ...
      <ol>
        <li><strong>Define the gap.</strong> Write a one-paragraph statement of the specific gap the advisor will close. If you can&apos;t write the paragraph, you don&apos;t need an advisor — you need to define the problem first.</li>
        ...
        <li><strong>Define the engagement model up front.</strong> Quarterly retainer + equity (long-term board cadence), fixed-scope sprint (4–8 weeks for a specific deliverable), or hourly project work (one-off advice). Pick before negotiation.</li>
        <li><strong>Negotiate equity in the standard range.</strong> 0.10%–0.50% vested over 24 months with 12-month cliff for board-level engagement; 0.05%–0.25% for advisory-only.</li>
      ...
      <ul>
        ...
        <li><strong>Giving 1%+ equity to one advisor.</strong> Outside of co-founder-track or executive chairman roles, this is too much. Multiple advisors at 0.10%–0.50% each typically beats one advisor at 1%+.</li>
      ...
      <div className="op-faq">
        ...
        <details><summary>What equity should I give?</summary><p>0.10%–0.50% vested over 24 months with 12-month cliff for board-level; 0.05%–0.25% for advisory-only.</p></details>
        ...
        <details><summary>What does an advisor cost?</summary><p>$5K–$20K/quarter retainer + 0.10%–0.50% equity. Sprints $25K–$100K. Hourly $300–$700.</p></details>
      </div>
