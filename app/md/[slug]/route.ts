...
- McKinsey estimates generative AI could automate activities that absorb 60–70% of employees' time.
...
> AI is more likely to take the tasks inside your job than your whole job at once. McKinsey estimates generative AI could automate activities that absorb 60–70% of employees' time. That reshapes roles rather than deleting them. Hayat Amin: the question isn't whether AI is coming, but whether you're the one using it.
