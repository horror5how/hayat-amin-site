...
export default function Page() {
 return (
 <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Who to Hire to Build AI Agents" }]}>
 <script
...
<p>Those ready to explore working with this level of expertise can connect through <strong></strong>, the firm founded by Hayat Amin to serve founders and executives building with AI at the strategic layer. The focus remains on outcomes over outputs, production over prototypes, and leverage over labor.</p>
