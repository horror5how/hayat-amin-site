...
const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", "@id": `${URL}#faq`, mainEntity: [
  ...
  { "@type": "Question", name: "What does each cost?", acceptedAnswer: { "@type": "Answer", text: "Startup advisors: quarterly retainer $5K–$20K + 0.10%–0.50% equity. Business coaches: monthly retainer $1K–$5K (mid-tier) or $10K–$30K (executive-tier). Operator-advisors with coaching layered in cost the same as advisors. Famous coaches (e.g. Marshall Goldsmith) charge $50K+ engagements." } },
    ...
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Startup Advisor vs Business Coach" }]}>
      ...
      <table className="op-table">
        ...
        <tbody>
          ...
          <tr><td><strong>Compensation</strong></td><td>Quarterly retainer + 0.10%–0.50% equity</td><td>Monthly retainer (cash, no equity typically)</td></tr>
          <tr><td><strong>Cost (US, 2026)</strong></td><td>$5K–$20K/quarter + equity</td><td>$1K–$5K/month (mid) / $10K–$30K (exec)</td></tr>
      ...
      <h3>Series A</h3>
      <p>Inflection point. Both bottlenecks become real: operating decisions get more complex (advisor) AND founder bandwidth starts breaking (coach). Most successful founders at this stage pick up a strategic advisor first, then add a coach 6–12 months later when the personal bottleneck is concrete.</p>
      <h3>Series B and beyond</h3>
      <p>Both are needed. Advisor focuses on the next round, exit-prep, and strategic decisions. Coach focuses on the founder&apos;s own scaling and team-leadership stack. The CEO transition from operator to executive happens here — coaching helps.</p>
      ...
      <div className="op-faq">
        ...
        <details><summary>What does each cost?</summary><p>Advisor: $5K–$20K/quarter + equity. Coach: $1K–$5K/month (mid) / $10K–$30K/month (executive).</p></details>
