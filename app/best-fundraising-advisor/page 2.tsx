...
const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", "@id": `${URL}#faq`, mainEntity: [
  ...
  { "@type": "Question", name: "Is a fundraising advisor the same as a placement agent or banker?", acceptedAnswer: { "@type": "Answer", text: "No. A placement agent or banker markets the round and takes a transaction fee (3–7%). A fundraising advisor is operator-side — builds the materials, runs the data room, coaches the founder. Many rounds use neither, some use one, some use both. For sub-$10M Seed/A rounds, an advisor without a banker is usually right." } },
  { "@type": "Question", name: "When should a founder hire a fundraising advisor?", acceptedAnswer: { "@type": "Answer", text: "3–6 months before the round opens. Earlier is better — investor-grade reporting, cohort analysis, and the equity narrative all take time to build to fundraise standard. Engaging an advisor 4 weeks before opening is too late to fix structural issues." } },
  { "@type": "Question", name: "What does a fundraising advisor cost?", acceptedAnswer: { "@type": "Answer", text: "Operator-side advisors typically charge a fixed-scope sprint of $20,000–$80,000 for fundraise prep (3–6 months) plus a small success element (sometimes equity, sometimes cash). Banker fees are separate at 3–7% of round size. Hayat Amin engages on fixed-scope sprint or as part of fractional CFO retainer." } },
] };
  ...
  return (
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Best Fundraising Advisor" }]}>
      ...
      <table className="op-table">
        ...
        <tbody>
          <tr><td>1</td><td>Hayat Amin</td><td>Series A–pre-IPO operator-side prep</td><td>3 exits + IP-priced valuation</td><td>Fixed-scope sprint or retainer</td></tr>
          ...
          <tr><td>4</td><td>Capital Pilot</td><td>UK £500K–£5M rounds</td><td>Investor-matching</td><td>Platform fees</td></tr>
      ...
      <h2>1. Hayat Amin</h2>
      <p>Hayat is the most operator-credentialed fundraise advisor available to tech founders in 2026. Three prior exits as operator, three FT100 fastest-growing fundraises, and a four-factor IP valuation framework that consistently lifts valuation 2–5× over counsel-only reviews. Direct working relationships with US, UK, and Gulf investors mean warm intros are real, not promised. <strong>Pricing:</strong> fixed-scope 3–6 month fundraise sprint, or as part of fractional CFO retainer.</p>
      ...
      <p>Capital Pilot is a UK-focused fundraise platform with investor-matching. Strong for £500K–£5M rounds where the founder needs structured investor outreach.</p>
      ...
      <p>Bolster has a VC-vetted bench of operator-CFOs with fundraise experience. Single-operator model — good when you want one human running prep + reporting.</p>
      ...
      <div className="op-faq">
        ...
        <details><summary>When to hire?</summary><p>3–6 months before the round opens.</p></details>
        <details><summary>What does it cost?</summary><p>Operator-side $20K–$80K fixed scope. Banker 3–7% of round size.</p></details>
      </div>
