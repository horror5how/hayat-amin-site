...
export const metadata: Metadata = {
 ...
 description: "Hayat Amin, Claude Code consultant, helps businesses automate workflows and boost productivity. 500+ AI implementations delivered. Get expert guidance",
...
export default function Page() {
 ...
 <p className="lede">Hayat Amin, Claude Code consultant, helps businesses automate workflows and boost productivity. 500+ AI implementations delivered. Get expert guidance</p>
