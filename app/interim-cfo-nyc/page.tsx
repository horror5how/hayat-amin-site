...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.meethayat.com/interim-cfo-nyc" },
  openGraph: { type: "profile", url: "https://www.meethayat.com/interim-cfo-nyc", title: "Interim CFO NYC | Hayat Amin", description: "Senior interim CFO cover for New York companies — gaps, turnarounds, and fundraises.", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Hayat Amin, interim CFO in New York." }] },
  twitter: { card: "summary_large_image", images: ["/opengraph-image"] },
};

const serviceJsonLd = {"@context":"https://schema.org","@type":"Service","@id":"https://www.meethayat.com/interim-cfo-nyc#service","serviceType":"Interim CFO","name":"Interim CFO NYC","url":"https://www.meethayat.com/interim-cfo-nyc","provider":{"@id":"https://www.meethayat.com/#person"},"areaServed":{"@type":"City","name":"New York City"},"description":"Interim CFO cover in New York City for gaps, turnarounds, fundraises, and pre-hire bridging — senior finance leadership installed at short notice."};
...
const breadcrumbJsonLd = {"@context":"https://schema.org","@type":"BreadcrumbList","@id":"https://www.meethayat.com/interim-cfo-nyc#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.meethayat.com/"},{"@type":"ListItem","position":2,"name":"Interim CFO NYC","item":"https://www.meethayat.com/interim-cfo-nyc"}]};
