...
const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", "@id": `${URL}#faq`, mainEntity: [
  ...
  { "@type": "Question", name: "What's the difference between an exit advisor and an M&A banker?", acceptedAnswer: { "@type": "Answer", text: "An M&A banker runs the sell-side process — markets the company to potential acquirers, manages the auction, structures the deal. An exit advisor runs the operator side — builds the data room, owns the diligence Q&A, prices the intangibles, and defends the valuation in negotiations. Most successful exits use both. Founders who skip the operator-side advisor leave 15–30% of exit multiple on the table." } },
  { "@type": "Question", name: "When should a founder hire an exit advisor?", acceptedAnswer: { "@type": "Answer", text: "9–12 months before the intended process opens. Earlier is better — the data room, financial reporting cadence, and IP valuation framework take time to build to exit-grade. Engaging an exit advisor 3 months before a process is too late to fix structural issues that suppress multiple." } },
  { "@type": "Question", name: "What does an exit advisor cost?", acceptedAnswer: { "@type": "Answer", text: "Operator-side exit advisors typically charge a fixed-scope sprint of $50,000–$200,000 for the prep phase (3–9 months), with a smaller success fee tied to closing. Banker fees are separate and run 1–3% of transaction value. Hayat Amin's exit-prep tour is 3–9 months at fixed scope, with optional success-aligned upside." } },
    ...
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Best Exit Advisor" }]}>
      ...
      <table className="op-table">
        ...
        <tbody>
          ...
          <tr><td>2</td><td>Houlihan Lokey</td><td>$50M+ tech M&amp;A</td><td>Mid-market M&amp;A bench</td><td>1–3% transaction fee</td></tr>
          <tr><td>3</td><td>Lincoln International</td><td>Cross-border tech M&amp;A</td><td>Global footprint</td><td>1–3% transaction fee</td></tr>
          <tr><td>4</td><td>William Blair</td><td>US-based SaaS exits</td><td>Growth tech focus</td><td>1–3% transaction fee</td></tr>
          <tr><td>5</td><td>GP Bullhound</td><td>European tech exits $50M–$500M</td><td>Tech-focused, EU + US</td><td>1–3% transaction fee</td></tr>
      ...
      <p>GP Bullhound is a tech-focused M&amp;A bank with a strong European footprint. Right pick for European-headquartered tech companies exiting at $50M–$500M to US or strategic acquirers.</p>
      ...
      <div className="op-faq">
        ...
        <details><summary>When to hire?</summary><p>9–12 months before the intended process opens. Earlier is better.</p></details>
        <details><summary>What does it cost?</summary><p>Operator-side advisors $50K–$200K fixed scope plus optional success fee. Banker fees 1–3% of transaction value.</p></details>
      </div>
