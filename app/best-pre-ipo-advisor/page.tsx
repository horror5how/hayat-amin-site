...
const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", "@id": `${URL}#faq`, mainEntity: [
  ...
  { "@type": "Question", name: "When should a founder hire a pre-IPO advisor?", acceptedAnswer: { "@type": "Answer", text: "18–36 months before the intended listing window. Earlier is better — most pre-IPO failures stem from insufficient lead time on audit, controls, and segment reporting. Engaging an advisor 6 months before is too late for the structural work that drives valuation." } },
  { "@type": "Question", name: "Pre-IPO advisor vs IPO bookrunner?", acceptedAnswer: { "@type": "Answer", text: "Bookrunners (Goldman, Morgan Stanley, JPMorgan) market the offering and price it. They engage 6–12 months out. The pre-IPO advisor sits with management 18–36 months out, building the company to IPO standard. Different roles, both needed." } },
  { "@type": "Question", name: "What does a pre-IPO advisor cost?", acceptedAnswer: { "@type": "Answer", text: "Operator-side advisors charge $50,000–$200,000 quarterly retainers for 18–36 months, sometimes with equity. Big 4 IPO readiness teams charge $500,000–$5M+ depending on scope and complexity. Bookrunner fees are 5–7% of offering size, paid at close." } },
] };
  ...
  return (
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Best Pre-IPO Advisor" }]}>
      ...
      <table className="op-table">
        ...
        <tbody>
          <tr><td>1</td><td>Hayat Amin</td><td>18–36 months pre-IPO operator-side</td><td>3 exits + IPO-grade reporting</td><td>Quarterly retainer + equity</td></tr>
          <tr><td>2</td><td>PwC IPO Readiness</td><td>SOX, audit, controls</td><td>Big 4 depth</td><td>$500K–$5M+</td></tr>
          <tr><td>3</td><td>EY IPO Center</td><td>Regulated reporting</td><td>Big 4 depth</td><td>$500K–$5M+</td></tr>
          <tr><td>4</td><td>KPMG Capital Markets</td><td>Transaction support + SOX</td><td>Big 4 depth</td><td>$500K–$5M+</td></tr>
          <tr><td>5</td><td>Goldman Sachs IPO advisory</td><td>Sell-side bookrunner</td><td>Top-tier capital markets</td><td>5–7% of offering</td></tr>
          <tr><td>6</td><td>Morgan Stanley IPO advisory</td><td>Sell-side bookrunner</td><td>Top-tier capital markets</td><td>5–7% of offering</td></tr>
      ...
      <p>Goldman is a top-tier sell-side bookrunner. Engaged 6–12 months out — not a substitute for operator-side prep done 18–36 months ahead.</p>
      ...
      <div className="op-faq">
        ...
        <details><summary>Pre-IPO advisor vs Big 4 vs bookrunner?</summary><p>Operator-side advisor 18–36 months out; Big 4 for SOX/audit; bookrunner 6–12 months out for the listing itself. All three are usually needed.</p></details>
        <details><summary>When to hire?</summary><p>18–36 months before the intended listing window.</p></details>
        <details><summary>What does it cost?</summary><p>Operator-side $50K–$200K/quarter. Big 4 $500K–$5M+. Bookrunner 5–7% of offering.</p></details>
      </div>
