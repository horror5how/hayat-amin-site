...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.meethayat.com/part-time-cfo-san-francisco" },
  openGraph: { type: "profile", url: "https://www.meethayat.com/part-time-cfo-san-francisco", title: "Part-Time CFO SF | Hayat Amin", description: "Ongoing part-time CFO leadership for San Francisco founders, one to three days a week.", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Hayat Amin, part-time CFO in San Francisco." }] },
  twitter: { card: "summary_large_image", images: ["/opengraph-image"] },
};

const serviceJsonLd = {"@context":"https://schema.org","@type":"Service","@id":"https://www.meethayat.com/part-time-cfo-san-francisco#service","serviceType":"Part-time CFO","name":"Part-Time CFO SF","url":"https://www.meethayat.com/part-time-cfo-san-francisco","provider":{"@id":"https://www.meethayat.com/#person"},"areaServed":{"@type":"City","name":"San Francisco"},"description":"Part-time CFO services in San Francisco — ongoing senior finance leadership one to three days per week on a fixed monthly retainer for founders and scaling startups."};
...
const breadcrumbJsonLd = {"@context":"https://schema.org","@type":"BreadcrumbList","@id":"https://www.meethayat.com/part-time-cfo-san-francisco#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.meethayat.com/"},{"@type":"ListItem","position":2,"name":"Part-Time CFO SF","item":"https://www.meethayat.com/part-time-cfo-san-francisco"}]};
