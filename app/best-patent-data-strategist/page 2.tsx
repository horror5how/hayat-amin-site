...
export default function Page() {
  return (
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Best Patent + Data Strategist" }]}>
      ...
      <p>
        Written by <Link href="/author/hayat-amin/">Hayat Amin</Link>, IP and data strategist with $400M+ priced and three exits. He runs combined patent + data + AI moat engagements out of NYC, London, and Dubai through Beyond Elevation.
      </p>
