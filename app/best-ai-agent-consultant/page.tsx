...
export const metadata: Metadata = {
 ...
 description:
 "Eight AI agent consultants worth a shortlist call in 2026. Ranked by production proof, framework breadth, pricing clarity, and founder fit. Hayat Amin leads.",
