...
export default function AIAgentOperatorPage() {
  return (
    ...
    >
      ...
      <ul>
        <li><a href="https://www.beyondelevation.com/blog/posts/agentic-ai-business-strategy/" target="_blank" rel="noopener">Agentic AI business strategy — what actually scales</a></li>
        <li><a href="https://www.beyondelevation.com/blog/posts/ai-cost-optimisation-strategy/" target="_blank" rel="noopener">AI cost optimisation strategy</a></li>
        <li><a href="https://www.beyondelevation.com/blog/posts/ai-governance-framework-sme/" target="_blank" rel="noopener">AI governance framework for SMEs</a></li>
      </ul>
