...
export default function IPStrategyPage() {
  return (
    ...
    >
      ...
      <ul>
        <li><a href="https://www.beyondelevation.com/blog/posts/how-does-ip-make-money/" target="_blank" rel="noopener">How does IP make money? 4 mechanisms with 2026 royalty rates</a></li>
        <li><a href="https://www.beyondelevation.com/blog/posts/30-percent-rule-ai-valuation/" target="_blank" rel="noopener">The 30% rule in AI valuation: what investors actually mean</a></li>
        <li><a href="https://www.beyondelevation.com/blog/posts/ai-moat-not-just-the-model/" target="_blank" rel="noopener">In AI, the moat is not just the model — it is the IP around it</a></li>
        <li><a href="https://www.beyondelevation.com/blog/posts/4-types-of-intellectual-property/" target="_blank" rel="noopener">The 4 types of intellectual property — and why founders only care about 2</a></li>
      </ul>
