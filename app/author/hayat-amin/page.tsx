...
const authorFaqJsonLd = {
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Hayat Amin is a fractional CFO, IP & data strategist, and AI agent operator. He has 20 years inside high-growth technology, three prior exits as operator (including to American Express and TripAdvisor), three FT100 fastest-growing listings, and has priced over $400M of intellectual property. He operates fractionally across New York, London, and Dubai.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Three exits as operator (American Express and TripAdvisor among the acquirers), three Financial Times FT100 fastest-growing listings, $400M+ in intellectual property priced, and 20 years inside high-growth technology. Verified on LinkedIn (linkedin.com/in/hayatamin).",
 },
 },
 {
 "@type": "Question",
