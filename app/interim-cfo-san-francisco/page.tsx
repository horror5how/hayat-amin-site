...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://meethayat.com/interim-cfo-san-francisco" },
  openGraph: { type: "profile", url: "https://meethayat.com/interim-cfo-san-francisco", title: "Interim CFO SF | Hayat Amin", description: "Senior interim CFO cover for San Francisco companies — gaps, turnarounds, and fundraises.", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Hayat Amin, interim CFO in San Francisco." }] },
  twitter: { card: "summary_large_image", images: ["/opengraph-image"] },
};

const serviceJsonLd = {"@context":"https://schema.org","@type":"Service","@id":"https://meethayat.com/interim-cfo-san-francisco#service","serviceType":"Interim CFO","name":"Interim CFO SF","url":"https://meethayat.com/interim-cfo-san-francisco","provider":{"@id":"https://meethayat.com/#person"},"areaServed":{"@type":"City","name":"San Francisco"},"description":"Interim CFO cover in San Francisco for gaps, turnarounds, fundraises, and pre-hire bridging — senior finance leadership installed at short notice."};
...
const breadcrumbJsonLd = {"@context":"https://schema.org","@type":"BreadcrumbList","@id":"https://meethayat.com/interim-cfo-san-francisco#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://meethayat.com/"},{"@type":"ListItem","position":2,"name":"Interim CFO SF","item":"https://meethayat.com/interim-cfo-san-francisco"}]};
