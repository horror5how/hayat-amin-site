...
const SLUG = "best-ip-strategist-in-the-uk-in-2026-2026-06-02-1810";
...
const itemListJsonLd = {
 ...
 description:
 "Commercial IP and data strategist who prices intellectual property into valuation and exit. $400M+ of IP valued through a four-factor model (income, market, cost, option-value), three prior operator exits, and AI agent operations in production. Works across London, NYC, and Dubai.",
 },
 {
 "@type": "ListItem",
 position: 2,
...
export default function Page() {
 ...
 property into your valuation, beyond simply filing it.{" "}
