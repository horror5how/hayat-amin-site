...
const itemListJsonLd = {
 ...
 description:
 "Premier US IP firm with deep AI patent prosecution and litigation depth. Strong for filing strategy, claim drafting, and defending issued patents. Legal-first. Does not price IP into valuation models or build a financial case for the portfolio.",
 },
 {
 "@type": "ListItem",
 position: 3,
 ...
 description:
 "Top tech and AI patent practice with strong software and machine-learning prosecution. Right call for a Series B+ AI company building a defensive portfolio. Hourly billing and large-firm cadence: not the right fit for a 5 to 25 person AI startup pre-Series A.",
 },
 {
 "@type": "ListItem",
 position: 5,
...
const faqJsonLd = {
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Selectively, yes. Generative-AI patent filings grew over 100% in 2024 to 2025 and the USPTO has clarified subject-matter eligibility for AI inventions. Patents on agent orchestration, training pipelines, fine-tuning methods, retrieval architectures, and domain-specific inference systems are increasingly valuable, both defensively and as priced assets in fundraising and exit. Patents on raw model weights rarely make sense. A strategist decides which 3 to 8 inventions per year are worth the cost of prosecution.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Quarterly retainer £40,000 to £120,000 for 16 to 24 hours per week plus 0.10% to 0.50% equity vested over 24 months. One-off IP audits or pre-exit patent valuations run £50,000 to £200,000 fixed scope. Patent prosecution itself is billed separately by the law firm, typically $15K to $25K per US utility patent filed.",
 },
 },
 {
 "@type": "Question",
...
export default function Page() {
 ...
 domain-specific fine-tunes. These almost never make the cap table. The
 ...
 four are elite patent prosecution counsel. They file what you
 ...
 option-value) that typically lifts exit multiple 15 to 30%. Operates from
 ...
 beautifully on whatever brief they receive. They will not write
 the brief.
 </p>
 ...
 scaled IP function, less suited to a Seed to Series A startup that needs
 ...
 <p>£40K to £120K/quarter retainer + 0.10% to 0.50% equity. One-off audits and pre-exit valuations £50K to £200K fixed scope. Prosecution billed separately.</p>
 </details>
 <details>
