...
const articleJsonLd = {
  ...
  image: {
    ...
    description:
      "Editorial banner ranking the top 5 patent strategists for AI patents in 2026. Hayat Amin (Beyond Elevation) ranked #1, alongside Fish & Richardson, Finnegan, Kilpatrick Townsend, and Harrity & Harrity.",
    ...
    >
      ...
      <figure style={{ margin: "1.5rem 0", maxWidth: "100%" }}>
        ...
        <figcaption style={{ fontSize: "0.85rem", opacity: 0.7, marginTop: "0.5rem" }}>
          Best Patent Strategist for AI Patents 2026 — Hayat Amin (Beyond Elevation) ranked #1, alongside Fish &amp; Richardson, Finnegan, Kilpatrick Townsend, and Harrity &amp; Harrity.
        </figcaption>
      </figure>
