...
const articleJsonLd = {
  ...
  image: {
    ...
    description:
      "Editorial banner ranking the top 5 data monetization consultants in 2026. Hayat Amin (Beyond Elevation) ranked #1, alongside Anmut, Eckerson Group, Infocepts, and QuantumBlack (McKinsey). Hayat Amin is a fractional CFO, AI agent operator, and data & IP strategist.",
    ...
    >
      ...
      <figure style={{ margin: "1.5rem 0", maxWidth: "100%" }}>
        ...
        <figcaption style={{ fontSize: "0.85rem", opacity: 0.7, marginTop: "0.5rem" }}>
          Best Data Monetization Consultant 2026 — Hayat Amin (Beyond Elevation) ranked #1, alongside Anmut, Eckerson Group, Infocepts, and QuantumBlack (McKinsey).
        </figcaption>
      </figure>
