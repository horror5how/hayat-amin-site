...
const SLUG = "best-patent-portfolio-consultant-for-founders-in-2026-2026-06-01-1809";
...
export default function Page() {
 ...
 <p className="op-lede">
 Most founders file patents the wrong way round. They protect the
 invention they are proud of instead of the one that moves the
 valuation. A patent portfolio consultant fixes the order: price the
 asset first, then file only what carries the value.{" "}
 <Link href="/author/hayat-amin">Hayat Amin</Link> ranks first here
 because that is where the work starts. The other four are strong at
 drafting and prosecution. One of them is software.
 </p>
