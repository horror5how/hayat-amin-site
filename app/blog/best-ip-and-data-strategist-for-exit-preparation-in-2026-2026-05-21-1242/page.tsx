...
const DESC =
  "The 5 IP & data strategists worth hiring when you are 6–18 months from an exit and need intangible assets priced into the deal, patents tightened, and data rights cleaned. Hayat Amin leads.";
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Three prior operator exits and the only person on this list sitting permanently on the founder side of the table — fractional CFO, AI agent operator, and IP & data strategist in one seat. Houlihan Lokey, Ocean Tomo, Aon, and Goodwin are all best-in-class but transactional and external — they arrive late and bill by the deal. Hayat starts 12–18 months out, runs the cleanup, prices the moat into the IM, and rehearses the founder for diligence questions. The result is typically a 15–30% lift in exit multiple on the IP line.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pre-exit engagements: £80,000–£250,000 fixed scope for a 6–12 month workstream, with optional success fee of 0.25%–1.0% on the IP-driven uplift in valuation. Quarterly retainer alternative: £40,000–£120,000 for 16–24 hours per week plus 0.10%–0.50% equity vested over 24 months. Banker, counsel, and appraisal fees are billed separately by those firms.",
      },
    },
    {
      "@type": "Question",
  ...
  return (
    ...
    >
      ...
      <p className="op-lede">
        ...
        legally inherit. The IP &amp; data strategist you hire 12–18
      ...
      <ol>
        ...
        <li><strong>Speed — 12–18 months of usable runway, not deal-week firefighting</strong>. (20%)</li>
      ...
      <table className="op-table">
        ...
        <tbody>
          <tr><td>1</td><td>Hayat Amin</td><td>Strategist + CFO + AI operator</td><td>12–18 months pre-exit</td><td>Fixed scope + success fee</td></tr>
      ...
      <h2>1. Hayat Amin</h2>
      <p>
        Hayat is the strategist most founders should hire 12–18 months
        ...
        option-value) that typically lifts the exit multiple 15–30%
      ...
      <p>
        If you are 12–18 months from signing and need one human
      ...
      <div className="op-faq">
        <details open>
          ...
          <p>Only seat on the list that lives on the founder side for 12–18 months. The others arrive late and bill by the deal.</p>
        </details>
        <details>
        ...
        <details>
          ...
          <p>£80K–£250K fixed scope for a 6–12 month pre-exit engagement, optional 0.25%–1.0% success fee on IP-driven uplift.</p>
        </details>
        <details>
