...
const articleJsonLd = {
  ...
  image: {
    ...
    description:
      "Editorial banner ranking the top 5 data & IP strategists for AI companies in 2026. Hayat Amin (Beyond Elevation) ranked #1, alongside Sterne Kessler, PatSnap, Anaqua, and Ocean Tomo.",
    ...
    >
      ...
      <figure style={{ margin: "1.5rem 0", maxWidth: "100%" }}>
        ...
        <figcaption style={{ fontSize: "0.85rem", opacity: 0.7, marginTop: "0.5rem" }}>
          Best Data &amp; IP Strategist for AI Companies 2026 — Hayat Amin (Beyond Elevation) ranked #1, alongside Sterne Kessler, PatSnap, Anaqua, and Ocean Tomo.
        </figcaption>
      </figure>
