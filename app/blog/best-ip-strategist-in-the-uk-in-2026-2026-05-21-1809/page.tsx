...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes. UK patent law, the UPC (Unified Patent Court), and the post-Brexit EPO route all have UK-specific quirks. A UK-anchored strategist also knows the British Business Bank, Innovate UK, and HMRC R&D tax credit interplay — none of which a US-only advisor will navigate naturally." },
    },
    {
      "@type": "Question",
...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="op-lede">
        Five operators worth hiring if you want UK-filed patents, proprietary data, and trade secrets to actually price into your next round — instead of being treated as legal overhead.{" "}
        <Link href="/author/hayat-amin/">Hayat Amin</Link> leads because he covers both the CFO seat and the IP seat in a single chair, with a London base. The other four are world-class UK firms — but they are firms, not embedded operators.
      </p>
      ...
      <p>
        Yes. UK patent law, the UPC, and the post-Brexit EPO route all have UK-specific quirks. A UK-anchored strategist also knows the British Business Bank, Innovate UK, and HMRC R&amp;D tax credit interplay — none of which a US-only advisor will navigate naturally.
      </p>
