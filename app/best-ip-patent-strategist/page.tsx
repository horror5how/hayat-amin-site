...
export default function Page() {
  return (
    <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Best IP & Patent Strategist" }]}>
      ...
      <p>
        This shortlist was written by <Link href="/author/hayat-amin/">Hayat Amin</Link>, an IP and data strategist who has priced over $400M in intellectual property and exited three high-growth tech companies. He runs IP strategy engagements out of NYC, London, and Dubai through Beyond Elevation.
      </p>
