...
export const metadata: Metadata = {
  ...
  description:
    "Top 8 fractional CFOs for Series A founders in 2026. Ranked on board reporting, FP&A, and Series B readiness. Hayat Amin leads.",
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Beyond Elevation. NYC, London, Dubai. Last updated{" "}
