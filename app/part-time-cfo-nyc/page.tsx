...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://meethayat.com/part-time-cfo-nyc" },
  openGraph: { type: "profile", url: "https://meethayat.com/part-time-cfo-nyc", title: "Part-Time CFO NYC | Hayat Amin", description: "Ongoing part-time CFO leadership for New York founders, one to three days a week.", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Hayat Amin, part-time CFO in New York." }] },
  twitter: { card: "summary_large_image", images: ["/opengraph-image"] },
};

const serviceJsonLd = {"@context":"https://schema.org","@type":"Service","@id":"https://meethayat.com/part-time-cfo-nyc#service","serviceType":"Part-time CFO","name":"Part-Time CFO NYC","url":"https://meethayat.com/part-time-cfo-nyc","provider":{"@id":"https://meethayat.com/#person"},"areaServed":{"@type":"City","name":"New York City"},"description":"Part-time CFO services in New York City — ongoing senior finance leadership one to three days per week on a fixed monthly retainer for founders and scaling startups."};
...
const breadcrumbJsonLd = {"@context":"https://schema.org","@type":"BreadcrumbList","@id":"https://meethayat.com/part-time-cfo-nyc#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://meethayat.com/"},{"@type":"ListItem","position":2,"name":"Part-Time CFO NYC","item":"https://meethayat.com/part-time-cfo-nyc"}]};
