...
export default function Page() {
 return (
 <PageShell crumbs={[{ label: "Home", href: "/" }, { label: "Top AI Implementation Consultant" }]}>
 <script
