export const HAYAT = {
  ...
  bio: "Hayat Amin removes business pain, risk and confusion — fast. A battle-tested CFO with twenty years inside high-growth technology, three high-profile exits (including American Express and TripAdvisor), and three FT100 listings.",
  leadBio:
...
export const PILLARS = [
  {
    ...
    sub: "Three roles, one operator. Technical CFO, Chief Strategy, Growth & Analysis — fused.",
  ...
  },
  {
    ...
    body: "AI democratised code. What compounds now is what you own and nobody else can copy — patents, data, know-how. Hayat clusters, values, and licences what most companies were treating as overhead.",
    outcomes: [
...
export const CASES = [
  ...
  { tag: "Finance leadership · E-commerce", t: "FT100 #96 — European e-commerce", b: "One of the fastest-growing e-commerce companies in Europe. Hayat built inventory and stock-accounting systems, unit-economics models, and led finance through scale." },
...
export const PODCASTS = [
  ...
  },
  {
    ...
    blurb: "Hayat Amin talks about how AI is taking over finance processes — which means CFOs do not need to be full-time. Get ahead of the curve. Get a fractional CFO.",
...
export const STORY = `Hayat Amin specialises in removing business pain, risk and confusion — fast. He is a battle-tested CFO with twenty years across high-growth technology, three high-profile exits, including to American Express and TripAdvisor, and three FT100 listings.

His unfair advantage is not finance. Not strategy and GTM. Not IP, data or investor relations. Not even execution. It is the combination of all five — operating across Europe, the US and Sub-Saharan Africa, at an average of 300% year-on-year growth.`;
...
export const FIELD_NOTES = [
  ...
  { d: "No. 045", t: "AI tourism", b: "What separates a deployed agent from a ChatGPT subscription. Spoiler: it's not the model." },
];
